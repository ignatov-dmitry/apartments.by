                    ...
                    <div class="blog_detail_container blog_grid_section">
                        <div class="box">
                            ...
                            <div class="detail-box">
                                ...
                                <form id="add_favorite" action="{{ route('addFavorite') }}" method="post">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="id" value="{{ $apartment->id }}">
                                </form>
                                <a class="btn-link" title="@if(!$apartment->isFavorite()) В избранное @else Удалить из избранного @endif" href="{{ route('addFavorite') }}" onclick="event.preventDefault();
                                                     document.getElementById('add_favorite').submit();">
                                    @if(!$apartment->isFavorite()) <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
