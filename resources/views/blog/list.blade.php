        ...
        <div class="container">
            <div class="row">
                @foreach($blogPosts as $blogPost)
                    <div class="col-md-6 ">
                        <div class="box">
                            <div class="img-box">
                                <img src="{{ $blogPost->image }}" class="img_w100" alt="{{ $blogPost->name }}">
                            </div>
			...
			h432V452z M472,148H40v-48c0-11.028,8.972-20,20-20h24v40h40V80h264v40h40V80h24c11.028,0,20,8.972,20,20V148z"></path>
                                ...
                                <div class="blog_bottom">
                                    <a href="{{ route('getBlogPost', ['blogPostId' => $blogPost->id]) }}" class="blog_btn">
                    <span>
                      Подробнее
                    </span>
                                    </a>
            ...
            {{ $blogPosts->appends(Request::all())->links('vendor.pagination.default') }}
        </div>
    </section>
@endsection