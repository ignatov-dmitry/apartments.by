            ...
            <table class="table table-hover">
                ...
                @foreach($customers as $customer)
                    <tr>
                        ...
                        <td><a href="{{ route('getUser', ['id' => $customer->id]) }}">Редактировать</a></td>
                        <td>
                            <a href="#" id="delete" data-toggle="modal" data-target="#modal-{{ $customer->id }}">Удалить</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form class="delete-apartment" action="{{ route('deleteUser') }}" method="POST">
                                                ...
                                                <button type="submit" name="apartment_{{ $customer->id }}" class="btn btn-danger">Удалить</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
