...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('regions')->insert([
            ['country_id' => 1, 'name' => 'Брестская обл.'],
            ['country_id' => 1, 'name' => 'Витебская обл.'],
            ['country_id' => 1, 'name' => 'Гомельская обл.'],
            ['country_id' => 1, 'name' => 'Гродненская обл.'],
            ['country_id' => 1, 'name' => 'Минская обл.'],
            ['country_id' => 1, 'name' => 'Могилевская обл.']
        ]);
